...
class SelectConsultRenderer {
    ...
    public static function render($patientId): string {
        ...
        return <<<HTML
            <button onclick="modalSelectConsult.showModal()">Générer une facture</button>

            <dialog id="modalSelectConsult">
                <h3>Sélectionner les consultations à facturer</h3>
                <p>Cochez les consultations que vous souhaitez ajouter à la facture</p>
                ...
                <div>
                    <div>
                        <div>
                            <label for="reduction-percent">Réduction (%):</label>
                        ...
                        <div>
                            <p><strong>Prix total:</strong> <span id="total-price">0,00</span> €</p>
                            <p><strong>Réduction:</strong> <span id="reduction-amount">0,00</span> €</p>
                            <p><strong>Total après réduction:</strong> <span id="final-price">0,00</span> €</p>
                        </div>
                    </div>
                </div>

                <div>
                    <button onclick="submitSelectConsultation()">Générer la facture</button>
                    <button onclick="modalSelectConsult.close()">Annuler</button>
                </div>
            </dialog>
