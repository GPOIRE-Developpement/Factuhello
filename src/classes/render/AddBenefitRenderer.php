...
<dialog id="modalBenefit">
    ...
    <button onclick="submitNewBenefit()" class="button button-primary">Ajouter la prestation</button>
    <button onclick="modalBenefit.close()" class="button button-ghost">Fermer</button>
</dialog>
